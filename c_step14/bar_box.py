    ...
    def draw_rgb_number(self, canvas,
        ...
        if delta > 0:
            ...
            if rank23d_color[0] == top2_byte:
                fit_font_top = top2_over_top
                triangle_font_top = top2_over_top
            # fit
            self.draw_3figures(
                canvas,
                rank23d_color[0],
            ...
            self.draw_3figures(
                ...
                rank23d_color[0],
                left+self.one_width,
                int(under_top - self.delta_3bars_height[0]),
                fit_font_color)
        ...
        if delta > 0:
            ...
            self.draw_3figures(
                ...
                rank23d_color[1],
                left+self.one_width,
                int(under_top - self.delta_3bars_height[1]),
                fit_font_color)
        ...
        if delta > 0:
            ...
            self.draw_3figures(
                ...
                rank23d_color[2],
                left+self.one_width,
                int(under_top - self.delta_3bars_height[2]),
                fit_font_color)
